...
class Walker : public rclcpp::Node {
    ...
    private:
        ...
        rclcpp::Subscription<sensor_msgs::msg::LaserScan>::SharedPtr subscriber_; //!< The pointer to the subscriber.
        geometry_msgs::msg::Twist bot_velocity_; //!< The calculated bot velocity.

        /**
         * @brief The callback funciton that subscribes to the topic and publishes the calculated velocity.
         * 
